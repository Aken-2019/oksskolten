...
export const dict = {
  ...
  'feeds.edit': { ja: 'フィードを編集', en: 'Edit Feed', zh: '编辑订阅源'},
  'feeds.editName': { ja: '名前', en: 'Name', zh: '名称'},
  'feeds.editUrl': { ja: 'サイト URL', en: 'Site URL', zh: '网站 URL'},
  'feeds.editCategory': { ja: 'カテゴリ', en: 'Category', zh: '分类'},
  'feeds.editSaved': { ja: 'フィードを更新しました', en: 'Feed updated', zh: '订阅源已更新'},
  ...
  'articles.unreadOnly': { ja: '未読', en: 'Unread', zh: '未读'},
  'articles.showAll': { ja: 'すべて', en: 'All', zh: '全部'},
  'articles.readFilter': { ja: '既読フィルタ', en: 'Read filter', zh: '阅读筛选'},
  ...
  'articles.readOnly': { ja: '既読', en: 'Read', zh: '已读'},
  ...
  'article.summarizing': { ja: '要約中', en: 'Summarizing...', zh: '正在摘要...'},
  'article.regenerateSummary': { ja: '再要約', en: 'Regenerate', zh: '重新摘要'},
  ...
  'article.translating': { ja: '翻訳中', en: 'Translating', zh: '正在翻译...'},
  ...
  'article.viewModeOriginal': { ja: '原文', en: 'Original', zh: '原文'},
  'article.viewModeImmersive': { ja: '対訳', en: 'Immersive', zh: '沉浸'},
  'article.viewModeTranslation': { ja: '全文訳', en: 'Translation', zh: '全文'},
  'article.retranslate': { ja: '再翻訳', en: 'Retranslate', zh: '重新翻译'},
  ...
  'settings.save': { ja: '保存して確認', en: 'Save & verify', zh: '保存并验证'},
  'settings.saving': { ja: '保存中...', en: 'Saving...', zh: '保存中...'},
  'settings.saved': { ja: '保存しました', en: 'Saved', zh: '已保存'},
  'settings.optional': { ja: '任意', en: 'optional', zh: '可选'},
  ...
  'settings.articleOpenModeSplit': { ja: '三列表示', en: 'Split view', zh: '三栏视图'},
  'settings.splitViewEmpty': { ja: '記事を選択してください', en: 'Select an article to read', zh: '选择一篇文章阅读' },
  ...
  'integration.hiddenProviders': { ja: '隠したプロバイダー', en: 'Hidden providers', zh: '已隐藏提供商'},
  ...
  'integration.column.function': { ja: '機能', en: 'Feature', zh: '功能'},
  'integration.column.mode': { ja: 'モード', en: 'Mode', zh: '模式'},
  'integration.column.provider': { ja: 'プロバイダー', en: 'Provider', zh: '提供商'},
  'integration.column.model': { ja: 'モデル', en: 'Model', zh: '模型'},
  ...
  'summary.auto': { ja: '要約を自動実行', en: 'Auto summarize', zh: '自动摘要'},
  'summary.autoOn': { ja: 'オン', en: 'On', zh: '开启'},
  'summary.autoOff': { ja: 'オフ', en: 'Off', zh: '关闭'},
  'translate.auto': { ja: '翻訳を自動実行', en: 'Auto translate', zh: '自动翻译'},
  'translate.autoOn': { ja: 'オン', en: 'On', zh: '开启' },
  'translate.autoOff': { ja: 'オフ', en: 'Off', zh: '关闭' },
  'translate.titleAuto': { ja: 'タイトルを自動翻訳', en: 'Auto translate titles', zh: '自动翻译标题' },
  'translate.titleAutoOn': { ja: 'オン', en: 'On', zh: '开启' },
  'translate.titleAutoOff': { ja: 'オフ', en: 'Off', zh: '关闭' },
  ...
  'provider.anthropic': { ja: 'Anthropic', en: 'Anthropic', zh: 'Anthropic'},
  'provider.gemini': { ja: 'Gemini', en: 'Gemini', zh: 'Gemini'},
  'provider.openai': { ja: 'OpenAI', en: 'OpenAI', zh: 'OpenAI'},
  ...
  // DeepSeek
  'deepseek.apiKey': { ja: 'DeepSeek API キー', en: 'DeepSeek API Key', zh: 'DeepSeek API 密钥'},
  'deepseek.apiKeySaved': { ja: 'DeepSeek API キーを保存しました', en: 'DeepSeek API key saved', zh: 'DeepSeek API 密钥已保存'},
  'deepseek.apiKeyDeleted': { ja: 'DeepSeek API キーを削除しました', en: 'DeepSeek API key deleted', zh: 'DeepSeek API 密钥已删除'},
  'deepseek.testConnection': { ja: '接続テスト', en: 'Test Connection', zh: '测试连接'},
  'deepseek.connected': { ja: '接続成功', en: 'Connected', zh: '已连接'},
  'deepseek.connectionFailed': { ja: '接続失敗', en: 'Connection failed', zh: '连接失败'},
  'deepseek.noModels': { ja: 'DeepSeek に接続できません', en: 'Cannot connect to DeepSeek', zh: '无法连接 DeepSeek'},

  // Mimo
  'mimo.apiKey': { ja: 'Mimo API キー', en: 'Mimo API Key', zh: 'Mimo API 密钥'},
  'mimo.apiKeySaved': { ja: 'Mimo API キーを保存しました', en: 'Mimo API key saved', zh: 'Mimo API 密钥已保存'},
  'mimo.apiKeyDeleted': { ja: 'Mimo API キーを削除しました', en: 'Mimo API key deleted', zh: 'Mimo API 密钥已删除'},
  'mimo.testConnection': { ja: '接続テスト', en: 'Test Connection', zh: '测试连接'},
  'mimo.connected': { ja: '接続成功', en: 'Connected', zh: '已连接'},
  'mimo.connectionFailed': { ja: '接続失敗', en: 'Connection failed', zh: '连接失败'},
  'mimo.noModels': { ja: 'Mimo に接続できません', en: 'Cannot connect to Mimo', zh: '无法连接 Mimo'},

  // Custom Provider
  'custom.baseUrl': { ja: 'Base URL', en: 'Base URL', zh: 'Base URL'},
  'custom.apiKey': { ja: 'API キー', en: 'API Key', zh: 'API 密钥'},
  'custom.add': { ja: '追加', en: 'Add', zh: '新增'},
  'custom.addDesc': { ja: 'カスタムプロバイダーの情報を保存', en: 'Save a custom provider configuration', zh: '保存自定义供应商配置'},
  'custom.fetchModels': { ja: 'モデル取得', en: 'Fetch Models', zh: '获取模型'},
  'custom.fetchingModels': { ja: '取得中...', en: 'Fetching...', zh: '获取中...'},
  'custom.availableModels': { ja: '利用可能なモデル', en: 'Available models', zh: '可用模型列表'},
  'custom.manualModelPlaceholder': { ja: 'gpt-4o', en: 'gpt-4o', zh: 'gpt-4o'},
  'custom.addModel': { ja: '追加', en: 'Add', zh: '添加'},
  'custom.selectAll': { ja: 'すべて選択', en: 'Select All', zh: '全选'},
  'custom.clearModels': { ja: '選択解除', en: 'Clear Selection', zh: '清空'},
  'custom.testConnection': { ja: '接続テスト', en: 'Test Connection', zh: '测试连接'},
  'custom.connected': { ja: '接続成功', en: 'Connected', zh: '已连接'},
  'custom.connectionFailed': { ja: '接続失敗', en: 'Connection failed', zh: '连接失败'},
  'custom.noModels': { ja: 'モデルが見つかりません', en: 'No models found', zh: '未找到模型'},
  'custom.requiredFields': { ja: '表示名と Base URL、モデルを入力してください', en: 'Please fill in provider name, Base URL, and at least one model', zh: '请填写提供商名称、Base URL，并至少选择/输入一个模型'},
  'custom.addProvider': { ja: 'カスタムプロバイダーを追加', en: 'Add Custom Provider', zh: '添加自定义提供商'},
  'custom.editProvider': { ja: 'プロバイダーを編集', en: 'Edit Provider', zh: '编辑提供商'},
  'custom.deleteProvider': { ja: 'プロバイダーを削除', en: 'Delete Provider', zh: '删除提供商'},
  'custom.deleteConfirm': { ja: 'このプロバイダーを削除しますか？', en: 'Delete this provider?', zh: '确定删除此提供商？'},
  'custom.providerName': { ja: 'プロバイダー名', en: 'Provider Name', zh: '提供商名称'},
  'custom.providerNamePlaceholder': { ja: 'My Custom Provider', en: 'My Custom Provider', zh: 'My Custom Provider'},
  'custom.apiFormat': { ja: 'API フォーマット', en: 'API Format', zh: 'API 格式'},
  'custom.apiFormatOpenAI': { ja: 'OpenAI 互換 API', en: 'OpenAI-compatible API', zh: 'OpenAI 兼容 API'},
  'custom.apiFormatAnthropic': { ja: 'Anthropic Messages API', en: 'Anthropic Messages API', zh: 'Anthropic Messages API'},
  'custom.searchModels': { ja: 'モデルを検索...', en: 'Search models...', zh: '搜索模型...'},
  'custom.showingModels': { ja: '${count} 件表示中', en: 'Showing ${count} models (enabled first)', zh: '显示 ${count} 个模型（已启用优先）'},
  'custom.noProviders': { ja: 'カスタムプロバイダーが設定されていません', en: 'No custom providers configured', zh: '暂无自定义提供商'},

  // Anthropic Advanced (base URL override)
  'anthropic.baseUrl': { ja: 'Base URL', en: 'Base URL', zh: 'Base URL'},
  ...
  'anthropic.settingsSaved': { ja: '設定を保存しました', en: 'Settings saved', zh: '设置已保存'},
  'anthropic.connected': { ja: '接続成功', en: 'Connected', zh: '已连接'},
  'anthropic.apiKeyDeleted': { ja: 'API キーを削除しました', en: 'API key deleted', zh: 'API 密钥已删除'},
  ...
  'googleTranslate.connected': { ja: '接続成功', en: 'Connected', zh: '已连接'},
  'googleTranslate.getApiKey': { ja: 'Google API キーを取得', en: 'Get Google API key', zh: '获取 Google API Key' },
  ...
  'deepl.connected': { ja: '接続成功', en: 'Connected', zh: '已连接'},
  'deepl.getApiKey': { ja: 'DeepL API キーを取得', en: 'Get DeepL API key', zh: '获取 DeepL API Key' },
  ...
  'openai.connected': { ja: '接続成功', en: 'Connected', zh: '已连接'},
  ...
  'gemini.connected': { ja: '接続成功', en: 'Connected', zh: '已连接'},
  ...
  'chat.apiKeyDelete': { ja: 'リセット', en: 'Reset', zh: '重置'},
